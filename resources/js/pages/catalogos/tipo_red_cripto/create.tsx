...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Crear tipo red cripto", href: "" },
]
...
export default function CreateTipoRedCriptoPage() {
    ...
    const onSubmit = (data: FormValues) => {
        router.post("/tipo_red_cripto", data)
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Tipo Red Cripto" />
            <div className="container mx-auto py-10 max-w-xl">
                <Card>
                    <CardHeader>
                        <CardTitle className="text-center">Registrar nuevo tipo de red cripto</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
