...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Crear operador movil", href: "" },
]
...
export default function CreateOperadorMovilPage() {
    ...
    const onSubmit = (data: FormValues) => {
        router.post("/mobile_operators", data)
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Operador Movil" />
            <div className="container mx-auto py-10 max-w-xl">
                <Card>
                    <CardHeader>
                        <CardTitle className="text-center">Registrar nuevo operador movil</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
