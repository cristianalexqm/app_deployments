...
import type { BreadcrumbItem, CardType } from "@/types"
...
export default function EditTipoTarjetaPage({ tarjeta }: { tarjeta: CardType }) {
    ...
    const onSubmit = (data: FormValues) => {
        router.put(`/card_types/${tarjeta.id}`, data)
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Tipo Tarjeta" />
            <div className="container mx-auto py-10 max-w-xl">
                <Card>
                    <CardHeader>
                        <CardTitle className="text-center">Editar tipo tarjeta</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
