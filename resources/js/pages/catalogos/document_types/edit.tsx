...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Editar tipo documento", href: "" },
]
...
export default function EditMonedaPage({ documentType }: { documentType: DocumentType }) {
    ...
    const onSubmit = (data: FormValues) => {
        router.put(`/document_types/${documentType.id}`, data)
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Tipo Documento" />
