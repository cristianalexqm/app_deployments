            ...
            return (
                <div className="flex justify-center gap-2">
                    ...
                    <Button
                        variant="outline"
                        size="icon"
                        onClick={() => router.visit(`/document_types/${document_types.id}/edit`)}
                    >
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>¿Eliminar tipo documento?</AlertDialogTitle>
                                <AlertDialogDescription>
                                    Esta acción no se puede deshacer. Se eliminará permanentemente el tipo
                                    de documento - <strong>{document_types.nombre}</strong>.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                    onClick={() => {
                                        router.delete(`/document_types/${document_types.id}`)
                                    }}
                                >
                                    Confirmar
                                </AlertDialogAction>
